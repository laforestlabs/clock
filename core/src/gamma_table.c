/*
 * gamma_table.c - GENERATED FILE, DO NOT EDIT.
 *
 * Regenerate with: python3 tools/gen_gamma.py > core/src/gamma_table.c
 *
 * CIE 1931 perceptual lightness curve, matching what esp-hub75 applies
 * on device. See tools/gen_gamma.py for the formula.
 */
#include "mirror/color.h"

const uint8_t ml_gamma_table[256] = {
...
uint8_t ml_gamma8(uint8_t v) { return ml_gamma_table[v]; }
